package top.javinjunfeng.springboot.oss;
...
public class OSSUnit {
    ...
    // 阿里云API的内或外网域名
    private static String ENDPOINT = "oss-cn-shanghai.aliyuncs.com"; // 注意，根据自身情况而定
...
//    }
    ...
    public static void main(String[] args) {
        ...
        File file = new File("/Users/zhangjunfeng/Desktop/郎酒发票.pdf");
//        String katarina = uploadObject2OSS(client, file, "katarina", "");
//        System.out.println(katarina);

        boolean katarina1 = downloadOSSObject(client, "katarina", "", "郎酒发票.pdf", "/Users/zhangjunfeng/");
    }
     ...
     * @param client OSS客户端
     * @param bucketName bucket名称
     * @param diskName 下载文件的目录  --bucket下文件的路径
     * @param ossFileName OSS中文件名
     * @param localPath 下载路径
     * @return
     */
    public static final boolean downloadOSSObject(OSSClient client, String bucketName, String diskName, String ossFileName, String localPath) {
        try {
            String resfile = localPath + ossFileName;
            BufferedInputStream bis = new BufferedInputStream(OSSUnit.getOSS2InputStream(client, bucketName, diskName, ossFileName));
